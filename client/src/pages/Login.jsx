      ...
      <div className="relative z-20 w-full max-w-lg p-6 animate-fadeIn">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-light text-white tracking-wide mb-3">
            Builders <span className="font-bold italic text-emerald-400">ERP</span>
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="pt-6 text-center">
              ...
              <p className="text-gray-400 text-xs font-light">
                Customer?{' '}
                <Link to="/portal" className="text-emerald-400 font-bold hover:text-emerald-300 hover:underline transition-colors">
                  Client Portal Login
                </Link>
              </p>
            </div>
