    ...
    <div className="flex h-screen items-center justify-center bg-gradient-to-br from-[#0e623a]/10 via-[#a7d8ff]/10 to-[#0e623a]/5 px-4 font-sans">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Register as a Builders ERP Employee</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="text-xs font-bold text-gray-500 uppercase block mb-1.5 tracking-wider">Full Name</label>
          ...
          <div>
            <label className="text-xs font-bold text-gray-500 uppercase block mb-1.5 tracking-wider">Email Address</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
          ...
          <div>
            <label className="text-xs font-bold text-gray-500 uppercase block mb-1.5 tracking-wider">Password</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
        ...
        <div className="mt-8 text-center border-t border-gray-100 pt-6">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#0e623a] font-bold hover:underline">
              Sign In
            </Link>
          </p>
        </div>
