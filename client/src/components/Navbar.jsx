...
const Navbar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      <header className={`h-16 bg-transparent border-none flex items-center justify-between px-4 md:px-8 fixed top-0 right-0 z-30 shadow-sm transition-all duration-300 ${sidebarOpen ? 'left-0 md:left-64' : 'left-0'}`}>
        {/* Title & Hamburger */}
