...
const Navbar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-8 fixed top-0 right-0 left-0 md:left-64 z-15 shadow-sm">
      {/* Title & Hamburger */}
